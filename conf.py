...
BLOG_AUTHOR = "Daniel Justice"  # (translatable)
BLOG_TITLE = "WifiCIDR Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.wificidr.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.wificidr.net/"
BLOG_EMAIL = "djustice@wificidr.net"
BLOG_DESCRIPTION = "WifiCIDR Blog"  # (translatable)
